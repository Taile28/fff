-- Whitelist table with UserId as keys
local whitelist = {
    [3957476717] = true, -- Add whitelisted UserIds here
    [3957540899] = true
}

-- Function to check if the player is whitelisted
local function isWhitelisted(player)
    return whitelist[player.UserId] ~= nil
end

-- Check if the local player is whitelisted
if isWhitelisted(game.Players.LocalPlayer) then
    -- Create the GUI elements
    local Adrenaline = Instance.new("ScreenGui")
    ...
    local BeamNotifier = Instance.new("TextButton")
    ...
    Adrenaline.Parent = game.CoreGui
    
    Main.Name = "Main"
    Main.Parent = Adrenaline
    Main.Active = true
    ...
    text2.Position = UDim2.new(0.4025721674, 0, 0.111111112, 0)
    text2.Size = UDim2.new(0, 148, 0, 48)
    text2.Font = Enum.Font.SciFi
    text2.Text = "adrenaline.monkey"
    text2.TextColor3 = Color3.new(1, 0.85098, 0)
    ...
    local OpenFrame = Instance.new("Frame")
    -- Additional properties for OpenFrame...
    
    local Open = Instance.new("TextButton")
    Open.Parent = OpenFrame
    -- Additional properties for Open...
    ...
    UserInputService.InputBegan:Connect(function(input, gameProcessedEvent)
        if input.UserInputType == Enum.UserInputType.Keyboard and not gameProcessedEvent then
            if input.KeyCode == Enum.KeyCode.E then
                isOpen = not isOpen -- Toggle the visibility state
                Main.Visible = not isOpen
                OpenFrame.Visible = isOpen
            end
        end
    end)
...
Category.Position = UDim2.new(0.7851572579, 0, 0.175983429, 0)
...
Category.ScrollBarImageColor3 = Color3.new(1, 0.85098, 0)  -- Change this color to your desired color
    ...
    LocalPlayerFrame.Position = UDim2.new(0.009245257, 0, 0.175983444, 0)
    LocalPlayerFrame.Selectable = true
    LocalPlayerFrame.Size = UDim2.new(0, 603, 0, 377)
    LocalPlayerFrame.Visible = false
    
    localptext.Name = "localptext"
    localptext.Parent = LocalPlayerFrame -- for the background frame of the script
    ...
    Imput.InputBegan:Connect(function(input)
        if input.UserInputType == Enum.UserInputType.MouseButton1 and Imput:IsKeyDown(Enum.KeyCode.V) then
            To(Mouse.Hit.p)
        end
    end)
    end)
    ...
    PlayersFrame.Position = UDim2.new(0.009245257, 0, 0.175983444, 0)
    PlayersFrame.Selectable = true
    PlayersFrame.Size = UDim2.new(0, 610, 0, 377)
    PlayersFrame.Visible = false
...
Category.ScrollBarImageColor3 = Color3.new(1, 0.85098, 0)  -- Change this color to your desired color
    ...
    WorldFrame.Position = UDim2.new(0.009245257, 0, 0.175983444, 0)
    WorldFrame.Selectable = true
    WorldFrame.Size = UDim2.new(0, 610, 0, 377)
    WorldFrame.Visible = false
    ...
    MapsFrame.Position = UDim2.new(0.009245257, 0, 0.175983444, 0)
    MapsFrame.Selectable = true
    MapsFrame.Size = UDim2.new(0, 610, 0, 377)
    MapsFrame.Visible = false
    ...
    ElderDinoFrame.Position = UDim2.new(0.009245257, 0, 0.175983444, 0)
    ElderDinoFrame.Selectable = true
    ElderDinoFrame.Size = UDim2.new(0, 610, 0, 377)
    ElderDinoFrame.Visible = false
    ...
    ExclusiveFrame.Position = UDim2.new(0.009245257, 0, 0.175983444, 0)
    ExclusiveFrame.Selectable = true
    ExclusiveFrame.Size = UDim2.new(0, 610, 0, 377)
    ExclusiveFrame.Visible = false
    ...
    FunFrame.Position = UDim2.new(0.009245257, 0, 0.175983444, 0)
    FunFrame.Selectable = true
    FunFrame.Size = UDim2.new(0, 610, 0, 377)
    FunFrame.Visible = false
    ...
    AutomationFrame.Position = UDim2.new(0.009245257, 0, 0.175983444, 0)
    AutomationFrame.Selectable = true
    AutomationFrame.Size = UDim2.new(0, 610, 0, 377)
    AutomationFrame.Visible = false
    ...
    DNAFarmFrame.Position = UDim2.new(0.009245257, 0, 0.175983444, 0)
    DNAFarmFrame.Selectable = true
    DNAFarmFrame.Size = UDim2.new(0, 610, 0, 377)
    DNAFarmFrame.Visible = false
    ...
    AdminStuffFrame.Position = UDim2.new(0.009245257, 0, 0.175983444, 0)
    AdminStuffFrame.Selectable = true
    AdminStuffFrame.Size = UDim2.new(0, 610, 0, 377)
    AdminStuffFrame.Visible = false
    ...
    local Adrenaline = Instance.new("ScreenGui")
    Adrenaline.Name = "Adrenaline"
    Adrenaline.Parent = game.Players.LocalPlayer.PlayerGui
    
    local OpenFrame = Instance.new("Frame")
    OpenFrame.Name = "OpenFrame"
    OpenFrame.Parent = Adrenaline
    ...
    -- Add the rest of the GUI elements here based on your provided list

    -- Your existing code for whitelisted users goes here
    print("You are whitelisted to use this script.")

    -- Continue with the rest of your code
    game.StarterGui:SetCore("SendNotification", {
        Title = "WHITELISTED",
        Text = "PRESS M TO TOGGLE MENU",
        Duration = 10
    })
